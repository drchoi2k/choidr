...
/* 메뉴 문자 상하위치 */
.topnav a {
    padding: 3px 15px 9px 25px !important;
}
.topnav {
    position: relative;
    z-index: 2;
...
<body style="position: relative; min-height: 100%; top: 40px;">
  <div class="w3-container top"><a class="w3schools-logo" href="//www.w3schools.com">교보테크(주)</a>
  ...
  <div class="w3-card-2 topnav" id="topnav" style="position: relative;">
    ...
    <!-- 메뉴바 상하 폭  -->
      <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:35px">
        <a href="javascript:void(0);" class="topnav-icons fa fa-menu w3-hide-large w3-left w3-bar-item w3-button" onclick="oopen_menu()" title="Menu"></a>

        <a href="/default.asp" class="topnav-icons fa fa-home w3-left w3-bar-item w3-button" title="Home"></a>
        <a class="w3-bar-item w3-button active" href="#" title="HTML Tutorial">홈</a>
        <a class="w3-bar-item w3-button" href="//ds.cathms.kr" title="CSS Tutorial">회사소개</a>
        <a class="w3-bar-item w3-button" href="#" title="JavaScript Tutorial">성형사업부</a>
