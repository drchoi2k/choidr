(function(q) {
    ...
    function q(a, b) {
        ...
        for (var f in Ka)
            if (Ka.hasOwnProperty(f)) Ka[f](this,
                b[f], Fd);
        Gd(this);
        ...
        for (var c = b.viewport, d = !0;; d = !1) {
            if (!d || !a.options.lineWrapping || b.oldDisplayWidth == pa(a))
                if (c && null != c.top && (c = {
                    ...
                    }), b.visible = Hc(a.display, a.doc, c), b.visible.from >= a.display.viewFrom && b.visible.to <= a.display.viewTo) break;
            if (!Lc(a, b)) break;
            Lb(a);
            d = jb(a);
            nb(a);
    ...
    function Kc(a) {
        for (var b = a.display, c = {}, d = {}, e = b.gutters.clientLeft,
                f = b.gutters.firstChild, g = 0; f; f = f.nextSibling, ++g) c[a.options.gutters[g]] = f.offsetLeft + f.clientLeft + e, d[a.options.gutters[g]] = f.clientWidth;
        return {
            fixedPos: Ic(b),
    ...
    function Qd(a, b, c, d) {
        ...
        if (a.options.lineNumbers || e) {
            ...
            if (e)
                for (b = 0; b < a.options.gutters.length; ++b) c = a.options.gutters[b],
        ...
        if (b.cache.hasOwnProperty(f)) a =
            ...
            if (3 == d.nodeType) {
                for (m =
                    ...
                    if (B && 9 > C && 0 == h && l == k.coverEnd - k.coverStart) n = d.parentNode.getBoundingClientRect();
    ...
    function $d(a, b, c) {
        for (var d, e, f, g, h = 0; h < a.length; h += 3) {
            ...
            else if (h == a.length - 3 || b == l && a[h + 3] > b) f = l - k, e = f - 1, b >= l && (g = "right");
            if (null != e) {
                d = a[h + 2];
    ...
    function fd(a, b, c) {
        ...
        0 > b && (b = 0);
        for (d = u(d, e);;)
            if (e = Ef(a, d, e, b, c), f = (d = Aa(d, !1)) && d.find(0, !0), d &&
                (e.ch > f.from.ch || e.ch == f.from.ch && 0 < e.xRel)) e = F(d = f.to.line);
            else return e
    }
    ...
    function Ef(a, b, c, d, e) {
        ...
        for (;;) {
            ...
            var v = Math.ceil(p / 2),
                w = e + v;
            if (m)
                for (var w = e, x = 0; x < v; ++x) w = gd(b, w, 1);
            x = f(w);
            if (x > d) {
                n = w;
                t = x;
    ...
    function Ja(a) {
        ...
        Ta ? Ta.ops.push(a.curOp) : a.curOp.ownsGroup = Ta = {
            ops: [a.curOp],
            delayedCallbacks: []
        }
    }
    ...
    function La(a) {
        if (a = a.curOp.ownsGroup) try {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                if (g)
                    for (k = 0; k < g.length; ++k) g[k].lines.length && K(g[k], "unhide");
    ...
    function Q(a, b, c, d) {
        ...
        else if (c <= e.viewFrom) ra && Ld(a.doc, c + d) > e.viewFrom ? qa(a) : (e.viewFrom += d, e.viewTo += d);
        else if (b <= e.viewFrom && c >= e.viewTo) qa(a);
        else if (b <= e.viewFrom) {
            var f = dc(a, c, c + d, 1);
            f ? (e.view = e.view.slice(f.index), e.viewFrom = f.lineN, e.viewTo += d) : qa(a)
        } else if (c >= e.viewTo)(f = dc(a, b, b, -1)) ? (e.view = e.view.slice(0, f.index), e.viewTo = f.lineN) : qa(a);
        else {
            var f = dc(a, b, b, -1),
                g = dc(a, c, c + d, 1);
            f && g ? (e.view =
    ...
    function dc(a, b, c, d) {
        var e = Ca(a, b),
            f = a.display.view;
        if (!ra || c == a.doc.first + a.doc.size) return {
            index: e,
            lineN: c
        };
    ...
    function sf(a) {
        ...
        d.dragFunctions = {
            ...
            start: function(b) {
                ...
                else if (!ja(a, b) && !oa(a.display, b) && (b.dataTransfer.setData("Text", a.getSelection()), b.dataTransfer.setDragImage &&
                        !te)) {
    ...
    function pe(a) {
        ...
        if (!(b.activeTouch && b.input.supportsTouch() || ja(this, a)))
            if (b.shift = a.shiftKey, oa(b, a)) J || (b.scroller.draggable = !1, setTimeout(function() {
                b.scroller.draggable = !0
            }, 100));
            else if (!hd(this, a, "gutterClick", !0,
                L)) {
            var c = Ua(this, a);
            window.focus();
            switch (xe(a)) {
        ...
        if (!ja(b, a) && !oa(b.display, a)) {
            ...
            if (c && !Rb(b))
                ...
                if (f = a.dataTransfer.getData("Text")) {
                    ...
                    Vb(b.doc, ga(c, c));
                    if (k)
                        for (h = 0; h < k.length; ++h) wb(b.doc, "", k[h].anchor, k[h].head, "drag");
    ...
    function lb(a, b) {
        2 > Math.abs(a.doc.scrollTop - b) || (a.doc.scrollTop = b, wa || Pc(a, {
                top: b
    ...
    function we(a) {
        if (!(oa(this.display, a) || ja(this, a) || a.ctrlKey && !a.altKey || W && a.metaKey)) {
            ...
            if (ba && b == md) md = null, O(a);
                ...
                if (b = String.fromCharCode(null == c ? b : c), !Sf(this, a, b)) this.display.input.onKeyPress(a)
        }
    }
    ...
    function Oa(a, b, c) {
        ...
        if (c = Ge && !c && Uf(a, b.from, b.to))
            for (var d = c.length - 1; 0 <= d; --d) He(a, {
                from: c[d].from,
                to: c[d].to,
                text: d ? [""] : b.text
            });
    ...
    function pb(a, b, c, d) {
        ...
        else if ("smart" == c && (m = e.mode.indent(f, h.text.slice(l.length), h.text), m == Ae || 150 < m)) {
            if (!d) return;
            c = "prev"
        }
    ...
    function od(a, b) {
        ...
        if (c)
            for (var h = 0, k; h < c.length; ++h) {
                var l = c[h],
                    m = l.marker;
                if (null == l.from || (m.inclusiveLeft ? l.from <= e : l.from < e) ||
        ...
        if (d)
            for (f = 0; f < d.length; ++f) h = d[f], null != h.to && (h.to += n), null == h.from ? (k = zb(c, h.marker), k || (h.from = n, g && (c || (c = [])).push(h))) : (h.from += n, g && (c || (c = [])).push(h));
        c && (c = Se(c));
        d && d != c && (d = Se(d));
        e = [c];
        if (!g) {
            var g = b.text.length - 2,
                q;
            if (0 < g && c)
                for (f = 0; f < c.length; ++f) null == c[f].to && (q || (q = [])).push(new qc(c[f].marker, null, null));
    ...
    function Ye(a, b, c, d) {
        ...
        var k = u(f, b.line),
            ...
            p;
        for (d && (p = []);
            (d || m.pos < b.ch) && !m.eol();) m.start = m.pos, h = ud(g, m, l), d && p.push(e(!0));
        return d ? p : e()
    }
    ...
    function Ze(a,
        ...
        var k = 0,
            ...
            p, n = a.options.addModeClass && [null];
            ...
            Ze(a, b.text, g.mode, !0, function(a, b) {
                ...
                if (b)
                    if (g.opaque) e.splice(c, h - c, a, "cm-overlay " + b), h = c + 2;
                        ...
                        for (; c < h; c += 2) d = e[c + 1], e[c + 1] = (d ? d + " " : "") + "cm-overlay " + b
            }, f)
        }
        return {
            styles: e,
    ...
    function Sd(a, b) {
        var c = t("span",
                null, null, J ? "padding-right: .1px" : null),
            c = {
                pre: t("pre", [c]),
                content: c,
                col: 0,
        ...
        for (var d = 0; d <= (b.rest ? b.rest.length : 0); d++) {
            ...
            a: {
                ...
                var h = $e(a, e, h),
                    ...
                    m = 0;
                if (k)
                    for (var p = l.length, n = 0, q = 1, r = "", u = void 0, v = void 0, w = 0, x = void 0, y = void 0, A = void 0, C = void 0, z = void 0;;) {
                        if (w == n) {
                        ...
                        for (var q = 1; q < h.length; q += 2) g.addToken(g, l.slice(m, m = h[q]), af(h[q + 1], g.cm.options))
            }
    ...
    function Ie(a, b, c, d) {
        ...
        if (h) {
            ...
            for ((g = A(e.done)) && g.ranges || Wb(a.sel, e.done), g = {
                    changes: [pd(a, b)],
        ...
        for (var d = 0, e = []; d < a.length; ++d) {
            ...
            if (f.ranges) e.push(c ? la.prototype.deepCopy.call(f) : f);
                ...
                for (var h = 0; h < f.length; ++h) {
                    ...
                    if (b)
                        for (var m in k)(l = m.match(/^spans_(\d+)$/)) && -1 < D(b, Number(l[1])) && (A(g)[m] = k[m], delete k[m])
                }
            }
        }
        return e
        ...
        for (var e = 0; e < a.length; ++e) {
            ...
            if (f.ranges) {
                ...
                for (h = 0; h < f.changes.length; ++h) {
                    var k = f.changes[h];
                    if (c < k.from.line) k.from = r(k.from.line + d, k.from.ch), k.to = r(k.to.line + d, k.to.ch);
                    else if (b <= k.to.line) {
                        g = !1;
                        break
                    }
    ...
    Tc.prototype = V({
        ...
        poll: function() {
            ...
            T(a, function() {
                ...
                g.composing && (g.composing.range.clear(), g.composing.range = a.markText(g.composing.start, a.getCursor("to"), {
                    className: "CodeMirror-composing"
                }))
            });
            return !0
    ...
    Uc.prototype = V({
        init: function(a) {
            function b(a) {
                if (d.somethingSelected()) X = d.getSelections(), "cut" == a.type && d.replaceSelection("", null, "cut");
                else if (d.options.lineWiseCopyCut) {
                    var b = Vd(d);
                    X = b.text;
        ...
        showPrimarySelection: function() {
            ...
            if (!c || c.bad || !d || d.bad || 0 != y(Qb(c, d), b.from()) || 0 != y(Pb(c, d), b.to()))
        ...
        pollContent: function() {
            ...
            b = sa(xf(a, e, b, d, c));
            for (e = Da(a.doc, r(d, 0), r(c, u(a.doc, c).text.length)); 1 < b.length && 1 < e.length;)
                if (A(b) == A(e)) b.pop(), e.pop(), c--;
                else if (b[0] == e[0]) b.shift(), e.shift(), d++;
            else break;
            for (var g = 0, f = 0, h = b[0], k = e[0], l = Math.min(h.length, k.length); g < l && h.charCodeAt(g) == k.charCodeAt(g);) ++g;
            h = A(b);
            k = A(e);
    ...
    la.prototype = {
        ...
        deepCopy: function() {
            for (var a = [], b = 0; b < this.ranges.length; b++) a[b] = new z(Rc(this.ranges[b].anchor), Rc(this.ranges[b].head));
    ...
    q.prototype = {
        ...
        indentSelection: M(function(a) {
            for (var b = this.doc.sel.ranges, c = -1, d = 0; d < b.length; d++) {
                var e =
                    b[d];
                if (e.empty()) e.head.line > c && (pb(this, e.head.line, a, !0), c = e.head.line, d == this.doc.sel.primIndex && Pa(this));
                else {
                    for (var f = e.from(), e = e.to(), g = Math.max(c, f.line), c = Math.min(this.lastLine(), e.line - (e.ch ? 0 : 1)) + 1, e = g; e < c; ++e) pb(this, e, a);
        ...
        heightAtLine: function(a, b) {
            ...
            return cd(this, d, {
                top: 0,
                left: 0
            }, b || "page").top + (c ? this.doc.height - ea(d) : 0)
        },
    ...
    q.getMode = function(a, b) {
        ...
        if (b.modeProps)
            for (e in b.modeProps) c[e] = b.modeProps[e];
        return c
    };
            ...
            transposeChars: function(a) {
                T(a, function() {
                    for (var b = a.listSelections(), c = [], d = 0; d < b.length; d++) {
                        ...
                        if (f)
                            if (e.ch == f.length && (e = new r(e.line, e.ch - 1)), 0 < e.ch) e = new r(e.line, e.ch + 1), a.replaceRange(f.charAt(e.ch - 1) + f.charAt(e.ch - 2), r(e.line, e.ch - 2), e, "+transpose");
    ...
    Ha.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var d = c = null, e = 0; e < this.lines.length; ++e) {
                ...
                for (var h = f, k = f.markedSpans, l = g, m = void 0, p = 0; p < k.length; ++p) k[p] != l && (m || (m = [])).push(k[p]);
                h.markedSpans = m;
                null == g.from && this.collapsed && !ya(this.doc, f) && a && ca(f, xa(a.display))
            }
            if (a && this.collapsed && !a.options.lineWrapping)
                for (e = 0; e < this.lines.length; ++e) f = ia(this.lines[e]), g = Kb(f), g > a.display.maxLineLength && (a.display.maxLine = f, a.display.maxLineLength = g, a.display.maxLineChanged = !0);
