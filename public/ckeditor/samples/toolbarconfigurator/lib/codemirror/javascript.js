(function(p) {
    ...
    p.defineMode("javascript", function(oa, t) {
        ...
        function x(a) {
            ...
            b.context ? (f.marked = "def", c(b.localVars) || (b.localVars = {
                name: a,
                next: b.localVars
            })) : !c(b.globalVars) && t.globalVars && (b.globalVars = {
                name: a,
                next: b.globalVars
            })
        }
        ...
        function l(a, c) {
            var b = function() {
                ...
                if ("stat" == b.lexical.type) e = b.lexical.indented;
                    ...
                    for (var h = b.lexical; h && ")" == h.type && h.align; h = h.prev) e = h.indented;
        ...
        return {
            ...
            token: function(a, b) {
                ...
                a: {
                    var d = E,
                        g = I,
                        h = b.cc;f.state = b;f.stream = a;f.marked = null;f.cc = h;f.style = e;b.lexical.hasOwnProperty("align") || (b.lexical.align = !0);
                    for (;;)
    ...
    p.defineMIME("application/json", {
        name: "javascript",
        json: !0
    });
    p.defineMIME("application/x-json", {
        name: "javascript",
        json: !0
    });
    p.defineMIME("application/ld+json", {
        name: "javascript",
        jsonld: !0
    });
    p.defineMIME("text/typescript", {
        name: "javascript",
        typescript: !0
    });
