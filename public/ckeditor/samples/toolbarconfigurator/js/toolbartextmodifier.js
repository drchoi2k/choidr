(function() {
    ...
    e.prototype._createModifier = function(a) {
        function d(a) {
            ...
            if (null !== b.charsBetween) {
                var d =
                    k.getUnusedButtonsArray(k.actualConfig.toolbar, !0, b.charsBetween),
                    e = a.getCursor(),
    ...
    e.prototype.getToolbarGroupByButtonName = function(a) {
        var d =
            this.fullToolbarEditor.buttonNamesByGroup,
            f;
        for (f in d)
    ...
    e.mapToolbarCfgToElementsList = function(a) {
        ...
        for (var f = [], c = a.length, b = 0; b < c; b += 1) a[b] && "string" !== typeof a[b] && (f = f.concat(g.filter(a[b].items, d)));
        return f
    };
        ...
        for (var f = {}, c = [], b = [], c = a.length, e = 0; e < c; e++)
            if ("/" === a[e]) b.push("/");
                ...
                for (var l = g.length, p = 0; p < l; p++) {
                    var n = g[p];
                    if ("-" !== n) {
                        var h = this.getToolbarGroupByButtonName(n); - 1 === m.groups.indexOf(h) && m.groups.push(h);
                        f[h] = f[h] || {};
