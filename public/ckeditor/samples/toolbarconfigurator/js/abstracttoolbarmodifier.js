...
Object.keys || (Object.keys = function() {
    ...
    return function(d) {
        ...
        if (b)
            for (f = 0; f < e; f++) a.call(d, c[f]) && g.push(c[f]);
        return g
    }
}());
(function() {
    ...
    a.prototype._onInit = function(b, c) {
        ...
        if (!this.actualConfig.toolbarGroups &&
            ...
            for (var a = this.actualConfig, d = this.editorInstance.toolbar, g = [], f = d.length, k = 0; k < f; k++) {
                var h = d[k];
                "string" == typeof h ? g.push(h) : g.push({
                    name: h.name,
    ...
    a.prototype._createToolbarBtn = function(b) {
        var c = ToolbarConfigurator.FullToolbarEditor.createButton("string" ===
            typeof b.text ? b.text : b.text.inactive, b.cssClass);
