...
(function() {
            ...
            elements: {
                ...
                img: function(e) {
                    if (e.parent && e.parent.attributes) {
                        ...
                        (a = a.style || a.STYLE) && a.match(/mso\-list:\s?Ignore/) &&
                ...
                p: function(a) {
                    ...
                    if (g.thisIsAListItem(b, a)) t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a), g.convertToFakeListItem(b,
                        a), n.array.reduce(a.children, function(a, e) {
                        "p" === e.name && (0 < a && (new CKEDITOR.htmlParser.element("br")).insertBefore(e), e.replaceWithChildren(), a += 1);
                        return a
                    }, 0);
                    else {
                ...
                font: function(a) {
                    ...
                    CKEDITOR.dtd.tr[a.parent.name] && CKEDITOR.tools.arrayCompare(CKEDITOR.tools.objectKeys(a.attributes), ["class", "style"]) ? k.createStyleStack(a, q, b) : x(a, q)
                },
                ul: function(a) {
                    if (c) return "li" == a.parent.name && 0 ===
                        n.indexOf(a.parent.children, a) && k.setStyle(a.parent, "list-style-type", "none"), g.dissolveList(a), !1
                },
                li: function(a) {
                    t.correctLevelShift(a);
                    c && (a.attributes.style = k.normalizedStyles(a, b), k.pushStylesLower(a))
                },
                ol: function(a) {
                ...
                span: function(a) {
                    ...
                    if (!a.attributes.style || a.attributes.style.match(/^mso\-bookmark:OLE_LINK\d+$/) ||
                        a.getHtml().match(/^(\s|&nbsp;)+$/)) {
                        for (var c = a.children.length - 1; 0 <= c; c--) a.children[c].insertAfter(a);
                        return !1
                    }
                ...
                table: function(a) {
                    ...
                    if (b.name && "div" === b.name && b.attributes.align &&
                        1 === n.objectKeys(b.attributes).length && 1 === b.children.length) {
                ...
                td: function(a) {
                    ...
                    (c = c["background-color"] || c["BACKGROUND-COLOR"]) && k.setStyle(a, "background-color",
                        c, !0);
                    var c = n.parseCssText(a.attributes.style),
                        p;
                    for (p in c) m = c[p], delete c[p], c[p.toLowerCase()] = m;
                    for (p = 0; p < f.length; p++) c[f[p]] && (m = c[f[p]], d[m] = d[m] ? d[m] + 1 : 1);
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        setStyle: function(a, b, c, d) {
            ...
            d && f[b] || ("" === c ? delete f[b] : f[b] = c, a.attributes.style = CKEDITOR.tools.writeCssText(f))
        },
        ...
        normalizedStyles: function(a, b) {
            var c = "background-color:transparent border-image:none color:windowtext direction:ltr mso- text-indent visibility:visible div:border:none".split(" "),
                ...
                f = function() {
                    for (var a = [], b = 0; b < arguments.length; b++) arguments[b] &&
                        a.push(arguments[b]);
                    return -1 !== n.indexOf(c, a.join(":"))
                },
                e = b && !0 === b.config.pasteFromWordRemoveFontStyles,
                h = n.parseCssText(a.attributes.style);
            "cke:li" == a.name && h["TEXT-INDENT"] && h.MARGIN && (a.attributes["cke-indentation"] = g.getElementIndentation(a), h.MARGIN = h.MARGIN.replace(/(([\w\.]+ ){3,3})[\d\.]+(\w+$)/, "$10$3"));
            for (var l = n.objectKeys(h), r = 0; r < l.length; r++) {
                var m = l[r].toLowerCase(),
                    p = h[l[r]],
                    k = CKEDITOR.tools.indexOf;
                (e && -1 !== k(d, m.toLowerCase()) || f(null, m, p) || f(null, m.replace(/\-.*$/, "-")) ||
                    f(null, m) || f(a.name, m, p) || f(a.name, m.replace(/\-.*$/, "-")) || f(a.name, m) || f(p)) && delete h[l[r]]
            }
        ...
        createStyleStack: function(a, b, c, d) {
            var f = [];
            a.filterChildren(b);
            for (b = a.children.length - 1; 0 <= b; b--) f.unshift(a.children[b]), a.children[b].remove();
            k.sortStyles(a);
        ...
        sortStyles: function(a) {
            for (var b = ["border", "border-bottom", "font-size", "background"], c = n.parseCssText(a.attributes.style), d = n.objectKeys(c), f = [], e = [], h = 0; h < d.length; h++) - 1 !== n.indexOf(b, d[h].toLowerCase()) ? f.push(d[h]) : e.push(d[h]);
            f.sort(function(a, c) {
        ...
        inliner: {
            ...
            parse: function(a) {
                ...
                var h;
                if (e)
                    for (e = e.cssRules, h = 0; h < e.length; h++) e[h].type === window.CSSRule.STYLE_RULE && a.push({
            ...
            sort: function(a) {
                return a.sort(function(a) {
                    ...
                    return function(a, b) {
                        ...
                        return 0 !== e ? e : c.indexOf(b.selector) - c.indexOf(a.selector)
                    }
                }(a))
            },
            inline: function(a) {
                ...
                CKEDITOR.tools.array.forEach(c, function(a) {
                    ...
                    a = d.find(a.selector);
                    var c, g, r;
                    for (r = 0; r < a.count(); r++) c = a.getItem(r), g = CKEDITOR.tools.parseCssText(c.getAttribute("style")), g = CKEDITOR.tools.extend({}, g, b), c.setAttribute("style", CKEDITOR.tools.writeCssText(g))
                });
                return d
            }
        }
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        removeSymbolText: function(a) {
            var b, c = a.attributes["cke-symbol"];
        ...
        numbering: {
            toNumber: function(a,
                ...
                function c(a) {
                    a = a.toUpperCase();
                    for (var b = 1, c = 1; 0 < a.length; c *= 26) b += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) * c, a = a.substr(0, a.length - 1);
                    return b
                }
                ...
                function d(a) {
                    ...
                    for (var c = b.length, d = 0, g = 0; g < c; ++g)
                        for (var m = b[g], p = m[1].length; a.substr(0, p) == m[1]; a = a.substr(p)) d += m[0];
                    return d
                }
                return "decimal" == b ? Number(a) : "upper-roman" == b || "lower-roman" ==
                    b ? d(a.toUpperCase()) : "lower-alpha" == b || "upper-alpha" == b ? c(a) : 1
            },
            getStyle: function(a) {
                a = a.slice(0, 1);
                var b = {
        ...
        createLists: function(a) {
            var b, c, d, f = g.convertToRealListItems(a);
                ...
                for (d = 0; d < h.length; d++) {
                    ...
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        var p = g.createList(b),
                            n = k.children;
                        0 < n.length ? n[n.length - 1].add(p) : (n = new CKEDITOR.htmlParser.element("li", {
        ...
        calculateValue: function(a) {
            ...
            var c = null,
                d, f, e;
            for (e = a; 0 <= e && null === c; e--) f = b.children[e], f.attributes && void 0 !== f.attributes.value && (d = e, c = parseInt(f.attributes.value, 10));
            null === c && (c = void 0 !== b.attributes.start ?
                parseInt(b.attributes.start, 10) : 1, d = 0);
            return c + (a - d)
        },
        ...
        chopDiscontinuousLists: function(a, b) {
            for (var c = {}, d = [
                ...
                var h = c[a[e].attributes["cke-list-level"]],
                    ...
                    k, m;
                h ? (m = h.type.match(/alpha/) && 7 == h.index ? "alpha" : m, m = "o" == a[e].attributes["cke-symbol"] && 14 == h.index ? "alpha" : m, k = g.getSymbolInfo(a[e].attributes["cke-symbol"],
                    m), l = this.getListItemInfo(a[e]), (h.type != k.type || f && l.id != f.id && !this.isAListContinuation(a[e])) && d.push([])) : k = g.getSymbolInfo(a[e].attributes["cke-symbol"]);
                for (f = parseInt(a[e].attributes["cke-list-level"], 10) + 1; 20 > f; f++) c[f] && delete c[f];
        ...
        toArabic: function(a) {
            return a.match(/[ivxl]/i) ?
                a.match(/^l/i) ? 50 + g.toArabic(a.slice(1)) : a.match(/^lx/i) ? 40 + g.toArabic(a.slice(1)) : a.match(/^x/i) ? 10 + g.toArabic(a.slice(1)) : a.match(/^ix/i) ? 9 + g.toArabic(a.slice(2)) : a.match(/^v/i) ? 5 + g.toArabic(a.slice(1)) : a.match(/^iv/i) ? 4 + g.toArabic(a.slice(2)) : a.match(/^i/i) ? 1 + g.toArabic(a.slice(1)) : g.toArabic(a.slice(1)) : 0
        },
        getSymbolInfo: function(a, b) {
            ...
            if (a in d || b && b.match(/(disc|circle|square)/)) return {
                index: d[a][1],
                type: d[a][0]
            };
            if (a.match(/\d/)) return {
        ...
        getListItemInfo: function(a) {
            if (void 0 !== a.attributes["cke-list-id"]) return {
    ...
    CKEDITOR.plugins.pastefromword.heuristics = {
        isEdgeListItem: function(a, b) {
            ...
            var c = "";
            b.forEach && b.forEach(function(a) {
                c += a.value
            }, CKEDITOR.NODE_TEXT);
        ...
        isDegenerateListItem: function(a, b) {
            return !!b.attributes["cke-list-level"] || b.attributes.style && !b.attributes.style.match(/mso\-list/) && !!b.find(function(a) {
                ...
                if (!d) return !1;
                var f = d["font-family"] || "";
                return (d.font || d["font-size"] || "").match(/7pt/i) && !!a.previous || f.match(/symbol/i)
            }, !0).length
        },
        assignListLevels: function(a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                for (var c = [g.getElementIndentation(b)], d = [b], f = [], e = CKEDITOR.tools.array, h = e.map; b.next && b.next.attributes && !b.next.attributes["cke-list-level"] && t.isDegenerateListItem(a, b.next);) b = b.next, c.push(g.getElementIndentation(b)),
                    d.push(b);
