...
(function() {
    ...
    var J = function(b) {
            ...
            for (d in b) {
                if (c = a.dialog.getContentElement(a.dialog._.currentTabId,
                        d)) c = c.getElement();
                else if (b[d].instance) c = b[d].instance.getElement().getFirst() || b[d].instance.getElement();
                else continue;
    ...
    var B = function(a) {
        ...
        w = function(b) {
            ...
            v[c.getCurrentLangGroup(a.selectingLang)].onShow();
            F(a.show_grammar);
            b.onchange = function(b) {
                ...
                f = a.cmd[f];
                b && v[b] && v[b].allowedTabCommands[f] || (f = v[b].defaultTabCommand);
                for (var h in a.cmd)
                    if (a.cmd[h] == f) {
                        a.previousTab = h;
                        break
        ...
        O = {
            ...
            grammerSuggest: function(b) {
                ...
                b = b.grammSuggest;
                for (var c = b.length, e = !0, d = 0; d < c; d++) a.grammerSuggest.getElement().append(L(b[d], b[d], e)), e = !1;
                l();
                a.div_overlay.setDisable()
            },
            ...
            options_checkbox_send: function(b) {
                ...
                g.postMessage.send({
                    message: b,
                    target: a.targetFromFrame[a.iframeNumber +
                        "_" + a.dialog._.currentTabId],
        ...
        N = function() {
            ...
            setTimeout(function() {
                    ...
                    if (g.misc.hasClass(c, "cke_dialog_tab") || g.misc.hasClass(c, "cke_dialog_contents_body") || !g.misc.isVisible(c))
        ...
        function c(a) {
            ...
            if (!a._.resized) {
                var r = n.height - a.parts.contents.getSize("height", !(CKEDITOR.env.gecko ||
                        CKEDITOR.env.opera || CKEDITOR.env.ie && CKEDITOR.env.quirks)),
            ...
            a._.moved || (r = isNaN(c) && isNaN(d) ? 0 : 1, isNaN(c) && (c = (m.width - n.width) / 2), 0 > c && (c = 0), c > m.width -
                n.width && (c = m.width - n.width), isNaN(d) && (d = (m.height - n.height) / 2), 0 > d && (d = 0), d > m.height - n.height && (d = m.height - n.height), a.move(c, d, r))
        }
            ...
            (function(a) {
                var b = {
                        ...
                        restoreDataFromString: function(a) {
                            ...
                            if ("string" ===
                                typeof a) switch (b = a.indexOf(this.separator), c = a.substring(0, b), b = a.substring(b + this.separator.length), c) {
                                case "boolean":
                                    b = "true" === b;
                                    break;
                                case "number":
                        ...
                        backCompatibility: function(a) {
                            var b = a,
                                c;
                            "string" === typeof a && (c = a.indexOf(this.separator), 0 > c && (b = parseFloat(a), isNaN(b) && ("[" === a[0] && "]" === a[a.length - 1] ? (a = a.replace("[", ""), a = a.replace("]", ""), b = "" === a ? [] : a.split(",")) :
                                b = "true" === a || "false" === a ? "true" === a : a), b = this.convertDataToString(b)));
                            return b
                        }
                    },
                    c = {
                    ...
                    d = {
                        ...
                        setCookie: function(a, b, c) {
                            ...
                            b = encodeURIComponent(b);
                            a = a + "\x3d" + b;
                            for (var h in c) b = c[h], a += "; " + h, !0 !== b && (a +=
                                "\x3d" + b);
                            document.cookie = a
                        },
        ...
        return {
            ...
            onShow: function() {
                ...
                if (CKEDITOR && CKEDITOR.config) {
                    ...
                    var d = "file:" == document.location.protocol ?
                        "http:" : document.location.protocol,
                        d = b.config.wsc_customLoaderScript || d + "//www.webspellchecker.net/spellcheck3/script/ssrv.cgi?plugin\x3dfck2\x26customerid\x3d" + a.wsc_customerId + "\x26cmd\x3dscript\x26doc\x3dwsc\x26schema\x3d22";
                    c(this);
                    CKEDITOR.scriptLoader.load(d, function(c) {
                        ...
                        b.plugins.scayt && (b.wsc.isSsrvSame = function() {
                            var a = CKEDITOR.config.wsc.DefaultParams.serviceHost.replace("lf/22/js/../../../", "").split("//")[1],
                                ...
                                e, h, f, g, p;
                            window.SCAYT && window.SCAYT.CKSCAYT && (f = SCAYT.CKSCAYT.prototype.basePath, f.split("//"), g = f.split("//")[1].split("/")[0], p = f.split(g + "/")[1].replace("/lf/scayt3/ckscayt/",
                                "") + "/script/ssrv.cgi");
                            !d || f || b.config.scayt_servicePath || (d.split("//"), e = d.split("//")[1].split("/")[0], h = d.split(e + "/")[1].replace("/lf/scayt3/ckscayt/ckscayt.js", "") + "/script/ssrv.cgi");
            ...
            onHide: function() {
                ...
                if (b.plugins.scayt && b.wsc && b.wsc.isSsrvSame) {
                    var c = b.wsc.udn,
                        e = b.wsc.ud,
                        f, l;
                    b.scayt ? (c ? (b.wsc.DataStorage.setData("scayt_user_dictionary_name", c), b.scayt.restoreUserDictionary(c)) : (b.wsc.DataStorage.setData("scayt_user_dictionary_name", ""), b.scayt.removeUserDictionary()),
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    children: [{
                                        ...
                                        type: "html",
                                        id: "logo",
                                        html: '\x3cimg width\x3d"99" height\x3d"68" border\x3d"0" src\x3d"" title\x3d"logo" alt\x3d"logo" style\x3d"display: inline-block;"\x3e',
                                        setup: function(b) {
                            ...
                            children: [{
                                ...
                                onClick: function() {
                                    ...
                                    "file:" == document.location.protocol ?
                                        alert("WSC: Options functionality is disabled when runing from file system") : (y = document.activeElement, b.openDialog("options"))
                                }
                            }]
                        }]
                    }]
    ...
    CKEDITOR.dialog.add("options", function(b) {
        ...
        return {
            ...
            onShow: function() {
                ...
                d.IgnoreAllCapsWords = e.IgnoreAllCapsWords.getValue() ?
                    1 : 0;
